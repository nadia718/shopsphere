...
function Categories() {
  ...
  const categories = [
    { id: 1, name: "Smartphone", image: Iphoneimage },
    { id: 2, name: "Laptop", image: Laptopimage },
    { id: 3, name: "Gaming", image: Gamingimage },
    { id: 4, name: "Accessories", image: Accessoriesimage },
  ];
    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 mt-3">Browse our premium collections</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {categories.map((category) => (
            ...
            >
              ...
              <button className="mt-3 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">
                Shop Now
              </button>
            </div>
          ))}
